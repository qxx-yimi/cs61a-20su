...
INSERT INTO stacks_helper SELECT dogs || ', ' || name, stack_height + height, height, 2 FROM stacks_helper, dogs WHERE last_height < height;
INSERT INTO stacks_helper SELECT dogs || ', ' || name, stack_height + height, height, 3 FROM stacks_helper, dogs WHERE last_height < height;
INSERT INTO stacks_helper SELECT dogs || ', ' || name, stack_height + height, height, 4 FROM stacks_helper, dogs WHERE last_height < height;
