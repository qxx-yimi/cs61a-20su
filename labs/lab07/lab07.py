...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    cur_score, total_score = 0, 0
    def make_glookup_helper(assignment, score):
        nonlocal cur_score, total_score
        cur_score += score
        total_score += class_assignments[assignment]
        return cur_score / total_score

    return make_glookup_helper
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n == 1:
        return 1
    return 2*(2*(n-1)-1)*num_trees(n-1)//n
...
def make_advanced_counter_maker():
    ...
    def counter_maker():
        ...
        def counter_operation(operation):
